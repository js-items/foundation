    ...
    describe("testFacade", function () {
        beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, options.facade.deleteItems({ filter: {} })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        test_5.default(options);
        test_6.default(options);
        test_7.default(options);
        test_8.default(options);
    });
});
//# sourceMappingURL=testFacade.js.map