    ...
    testUsingFilter_1.default({
        ...
        toGetAllItems: function (filter) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, facade.getItems({ filter: filter })];
                    case 1:
                        items = (_a.sent()).items;
                        expect(items).toEqual([testItem_1.firstItem, testItem_1.secondItem]);
                        return [2 /*return*/];
                }
            });
        }); },
        toGetFirstItem: function (filter) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        items = (_a.sent()).items;
                        expect(items).toEqual([testItem_1.firstItem]);
                        return [2 /*return*/];
                }
            });
        }); },
...
//# sourceMappingURL=runFilterTests.js.map